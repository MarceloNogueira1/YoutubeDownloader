...
#Logo----
l_logo = Label(frame_cima, image=logo, compound=LEFT, bg=fundo, font=('Roboto 12 bold'), anchor='nw')
l_logo.place(x=250, y=10)

#Titulo----
l_name = Label(frame_cima, text='Youtube Downloader', width=32, compound=LEFT, bg=fundo, fg=branca, font=('Roboto 16 bold'), anchor='nw')
l_name.place(x=200, y=100)

#URL----
l_url = Label(frame_cima, text='LINK:', bg=fundo, fg=branca, font=('Roboto 12 bold'), anchor='nw')
...
#Textos pós pesquisa-------------------
titulo_video = Label(frame_baixo, text='',wraplength=300, compound=LEFT, bg=fundo, fg=branca, font=('Roboto 14 bold'), anchor='nw')
titulo_video.place(x=250, y=0)

views_video = Label(frame_baixo, text='', bg=fundo, fg=branca, font=('Roboto 10 bold'), anchor='nw')
views_video.place(x=250, y=110)

duracao_video = Label(frame_baixo, text='', bg=fundo, fg=branca, font=('Roboto 10 bold'), anchor='nw')
duracao_video.place(x=250, y=134)

thumb_video = Label(frame_baixo, compound=LEFT, bg=fundo, font=('Roboto 12 bold'), anchor='nw')
...
#Botao pesquisar
b_buscar = Button(frame_cima, text='BUSCAR',command=pesquisar, width=10, bg=azul_marinho, fg=branca, font=('Arial 10 bold'), relief=RAISED, overrelief=RIDGE)
b_buscar.place(x=440, y=178)

b_down = Button(frame_baixo, image=down,command=download_video, bg=fundo, relief=RAISED, overrelief=RIDGE)
